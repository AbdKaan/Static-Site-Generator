...
class TestMarkdownToHTMLNode(unittest.TestCase):
    def test(self):
            ...
            children=[
                ...
                ParentNode(
                    ...
                    children=[
                        ...
                        ParentNode(
                            "li", children=[LeafNode(value="This is a list item")]
                        ),
                        ParentNode(
                            "li", children=[LeafNode(value="This is another list item")]
                        ),
                    ],
                ),
            ],
        ...
        if html_node.children and result.children:
    ...
    def test2(self):
        ...
        result = ParentNode(
            "div",
            children=[
                ParentNode(tag="h3", children=[LeafNode(value="This is a heading")]),
                ParentNode(
                    tag="pre",
                    children=[
                        ParentNode(
                            ...
                            children=[
                                LeafNode(
                                    value="This is a paragraph of text. It has some "
                                ),
                                LeafNode("b", "bold"),
                                LeafNode(value=" and "),
                                LeafNode("i", "italic"),
                ...
                ParentNode(
                    ...
                    children=[
                        ParentNode(
                            "li",
                            children=[
                                LeafNode(value="This is the first "),
                                LeafNode("i", "list"),
